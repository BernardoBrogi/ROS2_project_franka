...
def generate_launch_description():
    ...
    # Gazebo Sim
    # Include both package share roots so model://<package_name>/... URIs resolve.
    resource_roots = [
    ...
    arguments=[
        ...
        # '/' + 'fr3' + '/camera/image_raw@sensor_msgs/msg/Image@ignition.msgs.Image',
        # '/' + 'fr3' + '/camera/camera_info@sensor_msgs/msg/CameraInfo@ignition.msgs.CameraInfo',
        '/' + 'fr3' + '/depth_camera/points@sensor_msgs/msg/PointCloud2@ignition.msgs.PointCloudPacked',
        '/' + 'fr3' + '/depth_camera/camera_info@sensor_msgs/msg/CameraInfo@ignition.msgs.CameraInfo',
        '/' + 'fr3' + '/depth_camera/image@sensor_msgs/msg/Image@ignition.msgs.Image',
